...
function calculate91015() {
    ...
    if (checkSoffit) {
        if (soffit_distance < 0.45) {
            soffitResult = `
                <br><strong>Protection des soffites :</strong><br>
                Selon l'article 9.10.15.5.(8), auc// Tableau 3.2.3.1.-B - Usages des groupes A, B3, C, D et F3 - Sans gicleurs
const tableauGroupesAB3CDF3 = {
    10: {
        "< 3:1": [0, 8, 10, 18, 29, 46, 91, 100],
        "3:1 à 10:1": [0, 8, 12, 21, 33, 50, 96, 100],
...
// Fonction pour déterminer les exigences de construction basées sur le pourcentage et l'usage
function determineConstructionRequirements(percentage, usage, constructionType, revetementType) {
    let constructionRequirements = "<br><strong>Exigences de construction (selon 3.2.3.7):</strong><br>";
    
    if (usage === "groupes_A_B3_C_D_F3") {
        // Tableau 3.2.3.7 pour groupes A, B3, C, D et F3
        if (percentage <= 10) {
            constructionRequirements += "- Degré de résistance au feu: 1 h<br>";
            constructionRequirements += "- Type de construction: Incombustible<br>";
            constructionRequirements += "- Type de revêtement: Incombustible<br>";
        } else if (percentage <= 25) {
            constructionRequirements += "- Degré de résistance au feu: 1 h<br>";
            constructionRequirements += "- Type de construction: " + (constructionType === "incombustible" ? "Incombustible" : "Combustible") + "<br>";
            constructionRequirements += "- Type de revêtement: Incombustible<br>";
        } else if (percentage <= 50) {
            constructionRequirements += "- Degré de résistance au feu: 45 min<br>";
            constructionRequirements += "- Type de construction: " + (constructionType === "incombustible" ? "Incombustible" : "Combustible") + "<br>";
            constructionRequirements += "- Type de revêtement: Incombustible<br>";
        } else {
            constructionRequirements += "- Degré de résistance au feu: 45 min<br>";
            constructionRequirements += "- Type de construction: " + (constructionType === "incombustible" ? "Incombustible" : "Combustible") + "<br>";
            constructionRequirements += "- Type de revêtement: " + (revetementType === "incombustible" ? "Incombustible" : "Combustible") + "<br>";
        }
    } else {
        // Tableau 3.2.3.7 pour groupes E, F1 et F2
        if (percentage <= 10) {
            constructionRequirements += "- Degré de résistance au feu: 2 h<br>";
            constructionRequirements += "- Type de construction: Incombustible<br>";
            constructionRequirements += "- Type de revêtement: Incombustible<br>";
        } else if (percentage <= 25) {
            constructionRequirements += "- Degré de résistance au feu: 2 h<br>";
    ...
    // Ajouter des notes supplémentaires pour l'article 3.1.5.5
    if (percentage > 10 && revetementType === "combustible") {
        constructionRequirements += "<br>Note: Selon l'article 3.1.5.5, des exceptions peuvent permettre l'utilisation de revêtements combustibles ";
        constructionRequirements += "sur un mur extérieur dans certaines conditions spécifiques:<br>";
        constructionRequirements += "- Si le bâtiment a une hauteur d'au plus 3 étages ou est entièrement protégé par gicleurs<br>";
        constructionRequirements += "- Et si le mur satisfait aux critères d'essai de la norme CAN/ULC-S134<br>";
    }
