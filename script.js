...
function interpolateExact(x, x1, x2, y1, y2) {
   ...
   document.addEventListener('DOMContentLoaded', function() {
       ...
       // Nouvelle fonction d'interpolation selon la méthode exacte du document
       function interpolateExact(x, x1, x2, y1, y2) {
           if (x1 === x2) return y1;
           return y1 + ((x - x1) / (x2 - x1)) * (y2 - y1);
       }
       ...
       function calculateCNB() {
           ...
           // Trouver les surfaces les plus proches pour l'interpolation selon la méthode exacte
           // Déterminer la surface inférieure et supérieure
           ...
           // Interpolation des pourcentages pour la distance limitative - ÉTAPE 1 selon la méthode exacte
           const lowerSurfacePercentage = interpolateExact(
               limitingDistance,
               lowerDistance,
               upperDistance,
           ...
           const upperSurfacePercentage = interpolateExact(
               limitingDistance,
               lowerDistance,
               upperDistance,
           ...
           // Interpolation finale entre les surfaces, méthode exacte du document de référence - ÉTAPE 2
           let finalPercentage;
